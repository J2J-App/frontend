...
function transformData(input: {
    ...
    closing?: number;
    is_bonus?: boolean;
}[], year: string | number, userRank?: number) {
    const result: any = {};
        ...
        <div style={{
                    ...
                    <div style={{ width: "100%" }}>
                        ...
                        <div className={Styles.rankInputs}>
                            {ranks && ranks.map((rank, index) => {
                                const r = rankInputsMap[rank as keyof typeof rankInputsMap];
                                if (rank === "AC") {
                                    return (
                                        <div key={index} style={{
                                            display: "flex",
            ...
            {hasData && (
                <SortedTable
                    ...
                    mainsCRLRank={mainsCRLRank}
                    mainsCATRank={mainsCATRank}
                    advCATRank={advCATRank}
                    handleCollegeHover={handleCollegeHover}
