...
export default async function Page({
    ...
    if (counselling=="jac") {
        ...
        const { data:seatData } = await uniSeatMatrixData.json();
        function SeatMatrixData({department, seats, change, changeDirection, quota}: {
            department: string,
            seats: number,
            change: number,
            ...
            return <div className={styles.seatContainer}>
                        ...
                        <div style={{
                            ...
                            {change !== 0 && <div>
                                <div style={{
                                    ...
                                    alignItems: "center",
                                    backgroundColor: changeDirection === "increase" ? "rgba(145,255,145,0.18)" : "rgba(255,147,147,0.24)",
                                    padding: "1px 7px",
                                    borderRadius: "5px",
                                }}>
