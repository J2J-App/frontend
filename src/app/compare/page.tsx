...
export default function Page() {
  ...
  if (option01.length === 0) {
    option01 = [
      {
        value: `No Placement for this year`,
        label: `No Placement for this year`,
      },
    ];
  }
  ...
  useEffect(() => {
    ...
    const fetchData01 = async () => {
      try {
        const response = await fetch(`${API_URL}/v2/about/placement-branches`, {
          method: "POST",
          headers: {
  ...
  async function handleClick() {
    ...
    try {
      ...
      let response1, data1;
      try {
        response1 = await fetch(`${API_URL}/v2/placement/getPlacement`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
        ...
        throw new Error(
          `Error fetching data for ${firstUni}: ${error.message}`
        );
      }
      ...
      let response2, data2;
      try {
        response2 = await fetch(`${API_URL}/v2/placement/getPlacement`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Compare branches and colleges based on your preferences. This tool
            ...
            <div className={styles.cont}>
              ...
              <Combobox
                ...
                options={[
                  ...
                  {
                    value: "nsut-delhi-west-campus",
                    label: "NSUT Delhi (West Campus)",
                  },
                  {
                    value: "nsut-delhi-east-campus",
                    label: "NSUT Delhi (East Campus)",
                  },
                  ...
                  {
                    value: "iiitdm-kancheepuram",
                    label: "IIITDM Kancheepuram",
                  },
